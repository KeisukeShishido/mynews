                                ...
                                <tr>
                                    ...
                                    <td style="display:table; margin:10px;">
                                        <div style="display:table-cell;">
                                            <a class="btn btn-primary" style="margin-right:5px;" href="{{ action('Admin\NewsController@edit', ['id' => $news->id]) }}">編集</a>
                                        </div>
                                        <div style="display:table-cell;">
                                            <form action="{{ action('Admin\NewsController@delete') }}" method="post">
                                                {{ csrf_field() }}
